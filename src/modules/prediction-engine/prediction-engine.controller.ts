...
export class PredictionEngineController {
    ...
    @ApiOperation({ summary: 'Calcular la salud y predicción de servicios de un vehículo particular' })
    @ApiResponse({ status: 200, description: 'Reporte de salud y predicciones generadas exitosamente.' })
