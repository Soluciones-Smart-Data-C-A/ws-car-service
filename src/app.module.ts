...
@Module({
  imports: [UsersModule, AuthModule, VehiclesModule, PrismaModule, ServiceIconModule, ServiceModule, ServiceRuleModule, ServiceRecordModule, PredictionEngineModule],
